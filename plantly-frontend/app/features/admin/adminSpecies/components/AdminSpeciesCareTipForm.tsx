...
export default function AdminSpeciesCareTipForm({species, careTip}:{species: ISpeciesDtoData, careTip: ICareTipDtoData}) {
  ...
  const defaultValue = {
    ...
    pruningMonths: careTip.pruningMonths ? careTip.pruningMonths.toString() : '',
    wiringNotes: careTip.wiringNotes,
    wiringMonths: careTip.wiringMonths ? careTip.wiringMonths.toString() : '',
    propagationNotes: careTip.propagationNotes,
    propagationMonths: careTip.propagationMonths ? careTip.propagationMonths.toString() : '',
    pests: careTip.pests,
    soil: careTip.soil,
    notes: careTip.notes,
  };
