import type { Route } from "../../../../.react-router/types/app/features/plants/routes/+types/EditPlantRoute";
...
export default function EditPlantRoute({loaderData}: Route.ComponentProps) {
