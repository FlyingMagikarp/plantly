...
export class UpdateCareLogTypeEnum1775339845412 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TYPE "public"."care_log_type" RENAME TO "care_log_type_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."care_log_type" AS ENUM('WATER', 'FERTILIZE', 'PRUNE', 'REPOT', 'CHECK', 'MOVE_INSIDE', 'MOVE_OUTSIDE', 'PEST_TREATMENT')`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."care_log_type_old" AS ENUM('WATERING', 'FERTILIZING', 'PRUNING', 'REPOTTING', 'CHECK')`,
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."care_log_type_old" RENAME TO "care_log_type"`,
    );
  }
}
