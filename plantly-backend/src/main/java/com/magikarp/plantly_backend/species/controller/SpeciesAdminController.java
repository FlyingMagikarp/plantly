...
public class SpeciesAdminController {
    ...
    public ResponseEntity<Object> updateNames(@PathVariable("speciesId") Integer speciesId, @RequestBody SpeciesUpdateNamesRequestDto namesRequest) {
    ...
    public ResponseEntity<Object> updateCareTips(@PathVariable("speciesId") Integer speciesId, @RequestBody SpeciesUpdateCareTipsRequestDto careRequest) {
